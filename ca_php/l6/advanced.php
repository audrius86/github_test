...
#[ArrayShape(['products' => "array", 'cartDiscounts' => "int[]"])] function getShoppingCart(): array
{
    return [
        'products' => [
            'Comfy chair' => 'no data',
...
//    */
//
//    $productsArray = getShoppingCart();
//    echo implode(", ", array_keys($productsArray['products']));
//}
//
//exercise1();
